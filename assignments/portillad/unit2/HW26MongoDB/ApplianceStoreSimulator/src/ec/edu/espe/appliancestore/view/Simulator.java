...
import static ec.edu.espe.appliancestore.controller.Mongo.readBlenderMongo;
import static ec.edu.espe.appliancestore.controller.Mongo.writeBlenderMongo;
...
public class Simulator {
    ...
    public static void createUser(){
        ...
        if(mongo != null){
            ...
            insertUser(db,"Usuario",email,password);
    ...
    public static void insertUser(DB db , String collection , String email , String password){
       DBCollection colec = db.getCollection("Users");
    ...
    public static void showCollection(DB db,String collection){
        ...
        while(cursor.hasNext()){
            System.out.println("* "+cursor.next().get("email")+ "-" + cursor.curr().get("password"));
        }
    }
    public static void searchbyemail(DB db,String collection, String email){
     DBCollection colec = db.getCollection("Users");
    ...
    public static void selectObjects(){
        ...
        switch(select){
            case 1:    
                ...
                System.out.println("|2-> data MONGO     |");
                System.out.println("---------------------");
                selection=sc.nextInt();
            if(selection==1){
                ...
                if (selection ==2){
                    System.out.println("-------------------------|");
                    System.out.println("|1-> Enter data to Mongo |");
                    System.out.println("|2-> read data from mongo|");
                    System.out.println("-------------------------");
                    selection=sc.nextInt();
                    if (selection==1){
                        writeBlenderMongo();
