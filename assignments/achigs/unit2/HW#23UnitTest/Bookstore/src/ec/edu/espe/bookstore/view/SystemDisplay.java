...
import ec.edu.espe.bookstore.utils.Tax;
                        ...
                        switch(option){
                            case 1:
                                ...
                                do{
                                    ...
                                    Book books = new Book(title, author, id, price);
                                    listBook.add(books);
                                    jsonProduct = gson.toJson(books);
                                    
                                    System.out.println("Total price is: " + Tax.computePVP(price));
                                    System.out.println("Total gain is: " + Tax.computeGain(price));
                                    System.out.println("Price With IVA is: " + Tax.computeTotalPrice(price));
                            ...
                            case 2:
                                ...
                                do{
                                    ...
                                    Calculator calculators = new Calculator(model,brand, id, price);
                            ...
                            case 3:
                                ...
                                do{
                                    ...
                                    Folder folders = new Folder(material,color, id, price);
                            ...
                            case 4:
                                ...
                                do{
                                    ...
                                    Marker markers = new Marker(color,inkType, id, price);
                            ...
                            case 5:
                                ...
                                do{
                                    ...
                                    Notebook notebooks = new Notebook(type,numberOfPages, id, price);
                            ...
                            case 6:
                                ...
                                do{
                                    ...
                                    Pen pens = new Pen(color,tipType,id, price);
                                    listPen.add(pens);
