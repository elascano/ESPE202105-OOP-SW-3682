 ...
 */
public class FrmContactsRegistration1 extends javax.swing.JFrame {

    /**
     * Creates new form Contacts
     */
    public FrmContactsRegistration1() {
        initComponents();
        
    }
    
    private MongoClient createConection() {
        String cluster;
        MongoClientURI uri;
        ...
        database = mongoClient.getDatabase("BookOfContacts");
        collection = database.getCollection("Contact");
        return mongoClient;
    }
    
    private void addContact(String name, Integer numberOfFriends, float salary, String email){
        MongoClient conection = createConection();
        DB db = conection.getDB("ContactBook");
    ...
    private void initComponents() {
        ...
        btnListOfContacts = new javax.swing.JButton();
        ...
        btnListOfContacts.setText("List of Contacts");
        btnListOfContacts.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                btnListOfContactsActionPerformed(evt);
            }
        });
        ...
        layout.setHorizontalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addComponent(btnOK)
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                .addComponent(btnListOfContacts)
                .addGap(38, 38, 38))
    ...
    private void btnOKActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnOKActionPerformed
        ...
        if (option == 0) {
            ...
            addContact(name, numberOfFriends, salary, email);
            emptyFields();
    ...
    private void btnListOfContactsActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnListOfContactsActionPerformed
       // FrmListOfContacts frmListOfContacts = new FrmListOfContacts ();
              //  frmListOfContacts.setVisible(true);
    }//GEN-LAST:event_btnListOfContactsActionPerformed
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(FrmContactsRegistration1.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new FrmContactsRegistration1().setVisible(true);
            }
        });
    }

    // Variables declaration - do not modify//GEN-BEGIN:variables
    private javax.swing.JButton btnListOfContacts;
