...
public class CellPhoneStore {
    ...
    public static void main(String[] args) throws IOException {
        ...
        do {
            ...
            System.out.println("DATABASE WITH mongoDB");
            System.out.println("");
                ...
                case 1:
                    ...
                    switch (option) {
                        case 1:
                            ...
                            addCellphone(db, color, model, id, price, brand);
                            break;
    ...
    public static void addCellphone(DB db, String color, String model, int id, float price, String brand){
        DBCollection colection = db.getCollection("CellphoneDatabase");
