...
public static void read() throws FileNotFoundException, IOException, java.text.ParseException{
	...
	JSONParser parser = new JSONParser();
		...
		try{
			Object obj = parser.parse(new FileReader("D:\\- I. DE SOFTWARE\\Semestre\\1. Programacion Orientada a Objetos\\2do Parcial\\ASSIGNMENTS\\HW21Libraries\\HW21Libraries\\Inventory.json"));
