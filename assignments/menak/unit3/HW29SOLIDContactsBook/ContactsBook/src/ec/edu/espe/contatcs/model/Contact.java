...
import static utils.MongoDBManager.conection;
...
public class Contact {
    ...
    public static void addContact(String name, Integer numberOfFriends, float salary, String email, String book){
        MongoClient conection = conection();
        DB db = conection.getDB("ContactsBook");
        DBCollection colection = db.getCollection(book);
