...
public class SortApp extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        txtShowSortingMethod = new javax.swing.JTextField();
        ...
        layout.setHorizontalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(layout.createSequentialGroup()
                        .addContainerGap()
                        .addComponent(txtShowSortingMethod))
                    .addGroup(layout.createSequentialGroup()
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addGroup(layout.createSequentialGroup()
                                .addGap(176, 176, 176)
        ...
        layout.setVerticalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGap(18, 18, 18)
                .addComponent(txtShowSortingMethod, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
    ...
    private void btnSortActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSortActionPerformed
        ...
        txtShowSortingMethod.setText(sortingOption);
        
        unsortedArray = arrayString.toString();
                
        MongoClient conection = createConection();
        DB db = conection.getDB("SortingApp");
        DBCollection colection = db.getCollection("ArraysInformation");
        BasicDBObject document = new BasicDBObject();
        document.put("UnsortedArray",Arrays.toString(arrayString));
        document.put("Size",n);
        document.put("ChosenAlgorithm",sortingOption);
        document.put("SortedListOfNumbers",arrayShown);
    ...
    public static MongoClient createConection() {
        ...
        cluster = "mongodb+srv://Ariel:arieladriangh@cluster0.h3qnn.mongodb.net/myFirstDatabase?retryWrites=true&w=majority";
        uri = new MongoClientURI(cluster);
        mongoClient = new MongoClient(uri);
        database = mongoClient.getDatabase("SortingApp");
        collection = database.getCollection("ArraysInformation");
        return mongoClient;
    }
    /**
    ...
    private javax.swing.JTextField txtShowSortingMethod;
